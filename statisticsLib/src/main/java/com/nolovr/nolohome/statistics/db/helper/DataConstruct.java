...
import com.nolovr.nolohome.statistics.core.StaticsListener;
import com.nolovr.nolohome.statistics.model.AppAction;
import com.nolovr.nolohome.statistics.model.Event;
import com.nolovr.nolohome.statistics.model.KeyValueBean;
import com.nolovr.nolohome.statistics.model.Page;
import com.nolovr.nolohome.statistics.sp.SharedPreferencesHelper;
import com.nolovr.nolohome.statistics.util.DateUtil;
...
public class DataConstruct {
    ...
    public static void initEvent(StaticsListener eventInterface, String event_name) {
        initEvent(eventInterface, event_name, null);
    }
