...
import static com.nolovr.nolohome.statistics.core.TcNetEngine.TAG;
    ...
    public void onSend() {
        ...
        Platform.get().execute(new Runnable() {
            ...
            public void run() {
                ...
                // TODO: 2018/7/28 判断dataBlock 对象与上次发送的对象是否为通一个对象
//                // 如果是同一个对象则直接删除该对象
//                //TcUpLoadManager.getInstance(mContext).onSucess();
//                if (dataBlock != null && lastBlock != null && dataBlock.equals(lastBlock)) {
//                    TcUpLoadManager.getInstance(mContext).onSucess();
//                    return;
//                }
