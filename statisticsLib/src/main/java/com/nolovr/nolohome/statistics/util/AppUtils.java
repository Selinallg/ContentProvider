...
/**
 *
if(isAvilible(ForeverActivity.this, "com.tencent.mm")){
        Intent i = new Intent();
...
public class AppUtils {
    ...
    public static boolean checkActivityExist(Context mContext, String pack,
                                             String activity) {
    ...
    public static boolean isBackground(Context context, String packageName) {
        ...
        for (ActivityManager.RunningAppProcessInfo appProcess : appProcesses) {
            if (appProcess.processName.equals(packageName)) {
                 ...
                 */
                Log.i(packageName, "此appimportace ="
                ...
                if (appProcess.importance != ActivityManager.RunningAppProcessInfo.IMPORTANCE_FOREGROUND) {
                    ...
                    Log.i(packageName, "处于前台" + appProcess.processName);
                    return false;
                }
            }
        }
    ...
    //
    private void readMetaDataFromApplication(Context ctx) {
        try {
